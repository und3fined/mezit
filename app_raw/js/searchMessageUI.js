  ...
  exports.SearchMessageUI = {
    ...
    searchItem: function(searchInput) {
      ...
      function createNodes(thread) {
        ...
        let mmsLable = node.querySelector('.mms-icon');
        let smsLabel = node.querySelector('.body-text');
        let groupLabel = node.querySelector('.group-icon');
    ...
    onSearchInputChange: function(e) {
      let searchFocus = this.searchBox.classList.contains('search-focus');
