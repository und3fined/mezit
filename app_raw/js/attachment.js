...
(function(exports) {
  ...
  const ATTACHMENT_FOLDER_PATH = 'downloads/sms-attachments/';
  ...
  */
  ...
  Attachment.prototype = {
    ...
    render: function(readyCallback) {
      let attachmentRenderer = this._getAttachmentRenderer();
    ...
    view: function(options) {
      ...
      let filename = MimeMapper.ensureFilenameMatchesType(this.name, mimetype);
      ...
      if ((mimetype === 'text/x-vcard' ||
           mimetype === 'text/vcard' ||
           mimetype === 'text/directory') && (options && options.inComing)) {
        ...
        activity = new MozActivity({
          ...
          data: {
            ...
            forEditing: options && options.forEditing
          }
        });
      }
